...
public:
   ...
   * window.
   */
  typedef Callback<void, Ptr<const Packet> > mac_configCallback;
   ...
   */
  void Setmac_configCallback (mac_configCallback callback);
...
protected:
   ...
   */
  mac_configCallback m_mac_configCallback;
};
